...
if (!function_exists('add_action')) {
     ...
     * @param array|string $function Either a single function (string), or a class and method (array)
...
if (!function_exists('remove_action')) {
     ...
     * @param array|string $function Function or object/method to remove from tag
