 ...
 *
 * @see			http://getsparks.org/packages/template/show
 */
class Template
{
    private $_module = '';
    ...
    public function initialize($config = []): void
    {
        ...
        if ([] === $this->_theme_locations) {
            ...
            $this->_theme_locations = [FCPATH.'themes/'];
        }
    ...
    public function set_metadata($name, $content, $type = 'meta')
    {
        ...
        if ('keywords' == $name and !strpos($content, ',')) {
    ...
    private function _find_view_folder()
    {
        ...
        if (true === $this->_is_mobile and is_dir($view_folder.'mobile/')) {
    ...
    private function _load_view($view, array $data, $parse_view = true, $override_view_path = null)
    {
        ...
        // Can just run as usual
            ...
            $content = (true === $this->_parser_enabled and true === $parse_view)
    ...
    private function _guess_title()
    {
        ...
        return humanize(implode($this->_title_separator, $title_parts));
    }
