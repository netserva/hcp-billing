<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="col-lg-4 control-label"><?php echo lang('extension'); ?> <span class="text-danger">*</span></label>
                <div class="col-lg-8">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="form-control" name="default_registrar">
                        ...
                        <option value="<?php echo $registrar->system_name; ?>"><?php echo ucfirst($registrar->system_name); ?></option><?php } ?>
                    </select>
                </div>
            </div>
