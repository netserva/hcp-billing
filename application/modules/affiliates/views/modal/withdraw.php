...
<div class="modal-dialog modal-sm">
    <div class="modal-content">
        ...
        <h4 class="modal-title"><?php echo lang('request_withdrawal'); ?></h4>
        </div>
        <?php
            ...
            <div class="form-group">
            <label class="control-label"><?php echo lang('payment_details'); ?></label>
		...
		<div class="modal-footer"> <a href="#" class="btn btn-default btn-sm" data-dismiss="modal"><?php echo lang('close'); ?></a>
			<button type="submit" class="btn btn-success btn-sm"><?php echo lang('submit_withdrawal_request'); ?></button>
		</form>
	</div>
</div>
</div>
