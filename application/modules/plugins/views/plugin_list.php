<div class="row">
    <div class="col-md-12 col-sm-12">
        ...
        &nbsp; <a class="btn btn-xs btn-info pull-right" href="<?=base_url()?>plugins/add_plugin" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('upload')?></a>
        <a class="btn btn-xs btn-warning pull-right" href="<?=base_url()?>plugins/download"><i class="fa fa-download"></i> <?=lang('download_install')?></a> &nbsp;
           </div>
            <div class="box-body">
