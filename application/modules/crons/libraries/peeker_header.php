...
class peeker_header extends peeker_layers
{
    ...
    */
    ...
    {
        $del = false;
        if (isset($action_array['delete']) && true === $action_array['delete']) {
    ...
    {
        return str_contains(strtolower($this->fromaddress), strtolower($from_str));
    }
    ...
    {
        return str_contains(strtolower($this->toaddress), strtolower($to_str));
    }
