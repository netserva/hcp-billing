...
class Contact extends Hosting_Billing
{
    public function __construct()
    {
        ...
        $this->load->library(['template', 'form_validation', 'recaptcha', 'tank_auth']);
    ...
    public function index(): void
    {
        ...
        $data['use_recaptcha'] = ('TRUE' == config_item('use_recaptcha')) ? true : true;
        ...
        if ('TRUE' == config_item('captcha_registration')) {
        ...
        $this->template->set_layout('main')->build('pages/contact', $data ?? null);
    }
