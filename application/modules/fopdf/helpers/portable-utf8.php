...
declare(strict_types=1);
    ...
    function utf8_url_slug($str = '', $maxl = -1, $trns = false)
    {
        ...
        if (!strlen($str)) {
            $str = substr(md5(microtime(true)), 0, (-1 == $maxl ? 32 : $maxl));
        }
    ...
    function utf8_substr_count($haystack, $needle, $offset = 0, $length = null)
    {
        ...
        return  null === $length ? substr_count($haystack, $needle, $offset) : substr_count($haystack, $needle, $offset, $length);
    }
     ...
     */
    function utf8_trim_util(&$string, &$chrs): void
    {
        if (empty($chrs)) {
            $chrs = utf8_ws();
    ...
    function utf8_ltrim($string = '', $chrs = '')
    {
        ...
        while (isset($s_look[$count], $chrs[$s_look[$count]])) {
            ++$count;
        }
