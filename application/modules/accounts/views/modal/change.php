  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo lang('upgrade_account'); ?></h4>
      </div>
      <div class="modal-body">
		 ...
		 <?php $count = 0;
                ...
                foreach ($packages as $plan) { ?>
                    ...
                    <div class="columns">
                        <ul class="price">
                            <li class="<?php echo (2 == $count) ? 'highlight' : 'header'; ?>"><?php echo ucfirst($plan->item_name); ?></li>
                            <li class="grey">
                        ...
                        echo Applib::format_currency($client_cur, Applib::client_currency($client_cur, $price));
                            ...
                            <li class="grey"><a href="<?php echo base_url(); ?>accounts/show_options/<?php echo $plan->item_id; ?>" class="btn btn-success">Select</a></li>
                        </ul>
                    </div>
