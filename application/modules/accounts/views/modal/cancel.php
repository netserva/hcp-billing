<div class="modal-dialog">
	<div class="modal-content">
		...
		<h4 class="modal-title"><?php echo lang('cancel_account'); ?></h4>
		</div><?php
		...
		<button <?php echo ('TRUE' == config_item('demo_mode')) ? 'disabled' : ''; ?> type="submit" class="btn btn-<?php echo config_item('theme_color'); ?>"><?php echo lang('cancel_account'); ?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
