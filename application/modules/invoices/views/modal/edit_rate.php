<div class="modal-dialog">
	<div class="modal-content">
		...
		<h4 class="modal-title"><?php echo lang('edit_rate'); ?></h4>
		</div>
		...
		<?php
          ...
          <input type="hidden" name="tax_rate_id" value="<?php echo $r->tax_rate_id; ?>">
		<div class="modal-body">
			 
          				<div class="form-group">
				<label class="col-lg-4 control-label"><?php echo lang('tax_rate_name'); ?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
					<input type="text" class="form-control" required value="<?php echo $r->tax_rate_name; ?>" name="tax_rate_name">
				</div>
				</div>
				...
				<div class="col-lg-8">
					<input type="text" class="form-control money" required value="<?php echo $r->tax_rate_percent; ?>" name="tax_rate_percent">
				</div>
				</div>
