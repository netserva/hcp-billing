<div class="modal-dialog">
	<div class="modal-content">
		...
		<h4 class="modal-title"><?php echo lang('delete_order'); ?></h4>
		</div><?php
		...
		<h3><?php echo $item->domain; ?></h3>
					<table class="table table-bordered table-striped">		
						<thead><tr><th><?php echo lang('service'); ?></th><th><?php echo lang('nameservers'); ?></th><th><?php echo lang('delete'); ?></th></thead>
						<tbody> 
		...
		<button <?php echo ('TRUE' == config_item('demo_mode')) ? 'disabled' : ''; ?> type="submit" class="btn btn-<?php echo config_item('theme_color'); ?>"><?php echo lang('delete_domain'); ?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
