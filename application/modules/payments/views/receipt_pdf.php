        ...
        <table width="100%">
            <tr>
                ...
                <td width="40%" style="text-align: right;">
                    <div style="font-weight: bold; color: #111111; font-size: 20pt; text-transform: uppercase;"><?php echo stripAccents($lang2['receipt']); ?></div>
                    <table>
                        <tr>
                            <td width="10%">&nbsp;</td>
                            <td width="55%" style="color: <?php echo $color; ?>; text-align: left; font-size: 9pt; text-transform: uppercase;"><?php echo stripAccents($lang2['trans_id']); ?>:</td>
                            <td width="30%" style="text-align: right; font-size: 9pt;"><?php echo $pay->trans_id; ?></td>
                        </tr>
                        <tr>
                            <td width="10%">&nbsp;</td>
                            <td width="55%" style="color: <?php echo $color; ?>; text-align: left; font-size: 9pt; text-transform: uppercase;"><?php echo stripAccents($lang2['payment_date']); ?>:</td>
                            <td width="30%" style="text-align: right; font-size: 9pt;"><?php echo strftime(config_item('date_format'), strtotime($pay->payment_date)); ?></td>
                        </tr>
                        <tr>
                            <td width="10%">&nbsp;</td>
                            <td width="55%" style="color: <?php echo $color; ?>; text-align: left; font-size: 9pt; text-transform: uppercase;"><?php echo stripAccents($lang2['payment_method']); ?>:</td>
                            <td width="30%" style="text-align: right; font-size: 9pt;"><?php echo App::get_method_by_id($pay->payment_method); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
...
<table class="items" width="100%" style="border-spacing:3px; font-size: 9pt; border-collapse: collapse;" cellpadding="10">
    <thead>
    <tr>
            <td style="width:60%; text-align: left;"><?php echo stripAccents($lang2['description']); ?> </td>
            <td style="width:10%; text-align: left;"><?php echo stripAccents($lang2['qty']); ?> </td>
            <td style="width:15%; text-align: left;"><?php echo stripAccents($lang2['unit_price']); ?> </td>
            <td style="width:15%; text-align: right;"><?php echo stripAccents($lang2['amount']); ?> </td>
    ...
    <!-- ITEMS HERE -->
        ...
        <tr class="last">
                ...
                <div style="margin-bottom:6px; font-weight:bold; color: #111111;"><?php echo Invoice::view_by_id($pay->invoice)->reference_no; ?>
                </div>
                </td>
                <td width="10%"  style="text-align: center;"><?php echo Applib::format_quantity('1'); ?></td>
                <td width="15%" style="text-align: right;"><?php echo Applib::format_quantity($pay->amount); ?></td>
                <td width="15%" style="text-align: right;">
                <?php echo Applib::format_currency($pay->currency, $pay->amount); ?>
                </td>
        ...
        <td colspan="2" style="font-size: 8pt; color: #111111;"><strong><?php echo $lang2['sub_total']; ?></strong></td>
        <td style="font-weight: bold; color: #111111; text-align: right;"><?php echo Applib::format_quantity($pay->amount); ?></td>
        </tr>

         <tr>
        <td colspan="1" style="background-color:#ffffff;"></td>
        <td colspan="2" style="font-size: 8pt; color: #111111; background-color: <?php echo $color; ?>; color:#ffffff;"><strong><?php echo $lang2['total']; ?> (<?php echo $pay->currency; ?>)</strong></td>
        <td style="font-weight: bold; color: #111111; text-align: right; background-color: <?php echo $color; ?>; color:#ffffff;"><?php echo Applib::format_currency($pay->currency, $pay->amount); ?></td>
    </tr>
