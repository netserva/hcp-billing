<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<input type="hidden" name="invoice_id" value="<?php echo $order[0]->invoice_id; ?>">
			...
			<h3><?php echo lang('hosting'); ?></h3>		
              ...
              if ('domain' == $item->type || 'domain_only' == $item->type) { ?>
				...
				<p><?php echo lang('delete_order_warning'); ?></p>
				</div>
		...
		<button <?php echo ('TRUE' == config_item('demo_mode')) ? 'disabled' : ''; ?> type="submit" class="btn btn-<?php echo config_item('theme_color'); ?>"><?php echo lang('delete_order'); ?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
