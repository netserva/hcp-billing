...
<small><?php echo lang('welcome_back'); ?> , <?php echo User::displayName(User::get_id()); ?> </small>
 <?php
            $user = User::get_id();
...
<div class="row status_blocks">
        <div class="col-sm-6 col-md-3">
            ...
            <a class="clear" href="<?php echo base_url(); ?>domains">
                    <span class="info-box-icon"><i class="fa fa-globe fa-1x text-white"></i></span>
                    <span class="status_count"><?php echo Order::client_domains($user_company); ?></span><br>									 
                    <span class="label"><?php echo lang('domains'); ?> </span>										 					
                </a>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="info-box bg-green-gradient">
                <a class="clear" href="<?php echo base_url(); ?>accounts">
                    <span class="info-box-icon"><i class="fa fa-server fa-1x text-white"></i></span>	
                    <span class="status_count"><?php echo Order::client_accounts($user_company); ?></span><br>									 
                    <span class="label"><?php echo lang('accounts'); ?> </span>
                </a>					
            </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="info-box bg-light-blue">
                ...
                <span class="status_count"><?php echo App::counter('invoices', ['client' => $user_company, 'status !=' => 'Cancelled', 'status !=' => 'Deleted', 'status' => 'Unpaid']); ?></span><br>									 
        ...
        <div class="col-sm-6 col-md-3">
            <div class="info-box bg-purple-gradient">
                ...
                <span class="status_count"><?php echo App::counter('tickets', ['reporter' => $user, 'status !=' => 'closed']); ?></span><br>									 
            ...
            <div class="row">
                ...
                <div class="col-lg-4"> 
                    <section class="box box-default">
                        <header class="box-header"><?php echo lang('payments'); ?> </header>
                        <div class="box-body text-center"> <h4><small> <?php echo lang('paid_amount'); ?> : </small>
                                <?php echo Applib::format_currency($cur->code, Applib::client_currency($cur->code, Client::amount_paid($user_company))); ?></h4>
                            <small class="text-muted block">
                                <?php echo lang('outstanding'); ?> : <?php echo Applib::format_currency($cur->code, $client_outstanding); ?>
                            </small>
                            <div class="inline">

                                <div class="easypiechart" data-percent="<?php echo $perc_paid; ?>" data-line-width="16" data-loop="false" data-size="188">

                                    <span class="h2 step"><?php echo $perc_paid; ?></span>%
                                    <div class="easypie-text"><?php echo lang('paid'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="box-footer center"><small><?php echo lang('total'); ?>:
                                <strong><?php echo Applib::format_currency($cur->code, $client_payable); ?></strong></small>
                        </div> 
                    </section>
                </div>
                            ...
                            <section class="slim-scroll" data-height="285" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                                ...
                                <div class="list-group bg-white">
                                    ...
                                    foreach ($orders as $key => $order) {
                                       ...
                                       <span class="label label-default">  <?php echo ('domain' == $order->type || 'domain_only' == $order->type) ? $order->domain : $order->item_name; ?> </span> <span class="pull-right"><small><?php echo lang('next_payment'); ?>:</small> <span class="label <?php echo ($remaining < 10) ? 'label-warning' : 'label-default'; ?>"> <?php echo $remaining; ?></span><small><?php echo strtolower(lang('days')); ?></small></span> 
                                    </span>
                                    <?php
                                    } ?>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <section class="box box-default">
                        <div class="box-header"><?php echo lang('recent_activities'); ?></div>
                        <div class="box-body">
                            ...
                            <section class="slim-scroll" data-height="390" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                                <div class="list-group bg-white">
                                    ...
                                    foreach ($tickets as $key => $ticket) {
                                        ...
                                        <a href="<?php echo base_url(); ?>tickets/view/<?php echo $ticket->id; ?>" data-original-title="<?php echo $ticket->subject; ?>" data-toggle="tooltip" data-placement="top" title = "" class="list-group-item">
                                            <?php echo $ticket->ticket_code; ?> - <small class="text-muted"><?php echo lang('priority'); ?>: <?php echo $ticket->priority; ?> <span class="badge bg-<?php echo $badge; ?> pull-right"><?php echo $ticket->status; ?></span></small>
                                        </a>
                                    <?php
                                    } ?>
                                </div>
