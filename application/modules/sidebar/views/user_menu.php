    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
              ...
              $badge = [];
                ...
                <li><a href="<?php echo base_url(); ?>invoices/add_funds/<?php echo $client_co; ?>" data-toggle="ajaxModal"> 
                    <i class="fa fa-bank icon"></i>
                <span><?php echo lang('credit_balance'); ?></span> <span class="pull-right"><?php echo Applib::format_currency($cur->code, Applib::client_currency($cur->code, $client->transaction_value)); ?></span> </a> </li>

                <?php if ($this->session->userdata('admin')) { ?>
                <li class="header">ADMIN</li>
                <li><a class="btn btn-sm btn-block" href="<?php echo base_url(); ?>profile/switch_back">Switch Back</a></li>
                <?php } ?>
