...
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
         ...
         *
         * @see		https://github.com/stvnthomas/CodeIgniter-2.1-Multi-Upload
         */
        class MY_Upload extends CI_Upload
        {
             ...
             * @param mixed $reset
             */
            public function initialize(array $config = [], $reset = true): void
            {
            ...
            public function do_multi_upload($field)
            {
                ...
                foreach ($_FILES[$field]['name'] as $i => $v) {
                    ...
                    if (!empty($this->_multi_file_name_override[$i])) {
                        ...
                        if (!str_contains($this->_multi_file_name_override[$i], '.')) {
             ...
             * @param	$count	int
             */
            protected function _file_mime_type($file, $count = 0): void
            {
                //Mutliple file?
                ...
                if (DIRECTORY_SEPARATOR !== '\\') {
                    ...
                    if (false === (bool) @ini_get('safe_mode') && function_exists('shell_exec')) {
                        $mime = @shell_exec($cmd);
                        if (strlen($mime) > 0) {
                            $mime = explode("\n", trim($mime));
             ...
             */
            protected function set_multi_upload_data(): void
            {
                $this->_multi_upload_data[] = [
