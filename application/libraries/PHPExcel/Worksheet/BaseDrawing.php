...
class PHPExcel_Worksheet_BaseDrawing implements PHPExcel_IComparable
{
    ...
    public function setWidth($pValue = 0)
    {
        ...
        if ($this->_resizeProportional && 0 != $pValue) {
            $ratio = $this->_height / (0 != $this->_width ? $this->_width : 1);
    ...
    public function setHeight($pValue = 0)
    {
        // Resize proportional?
        if ($this->_resizeProportional && 0 != $pValue) {
            $ratio = $this->_width / (0 != $this->_height ? $this->_height : 1);
    ...
    {
        $xratio = $width / (0 != $this->_width ? $this->_width : 1);
        $yratio = $height / (0 != $this->_height ? $this->_height : 1);
