...
class PHPExcel_Writer_Excel5_Parser
{
    ...
    public function _convert($token)
    {
        ...
        if (preg_match('/^#[A-Z0\\/]{3,5}[!?]{1}$/', $token) or '#N/A' == $token) {
    ...
    public function _match($token)
    {
        switch ($token) {
            ...
            default:
                ...
                if (preg_match('/"([^"]|""){0,255}"/', $token) and '"' != $this->_lookahead and (0 == substr_count($token, '"') % 2)) {
                    return $token;
                }
    ...
    public function _expression()
    {
        ...
        if (preg_match('/^#[A-Z0\\/]{3,5}[!?]{1}$/', $this->_current_token) or '#N/A' == $this->_current_token) {
