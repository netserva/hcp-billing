...
class Chat extends Domain
{
    ...
    protected function getCredentials(): Chat\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid): Chat\V2\CredentialContext
    {
        return $this->v2->credentials($sid);
    }

    protected function getServices(): Chat\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid): Chat\V2\ServiceContext
    {
