...
class Pricing extends Domain
{
    ...
    protected function getMessaging(): Pricing\V1\MessagingList
    {
        return $this->v1->messaging;
    }

    protected function getPhoneNumbers(): Pricing\V1\PhoneNumberList
    {
        return $this->v1->phoneNumbers;
    }

    protected function getVoice(): Pricing\V2\VoiceList
    {
