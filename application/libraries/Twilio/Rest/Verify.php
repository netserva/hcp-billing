...
class Verify extends Domain
{
    ...
    protected function getForms(): Verify\V2\FormList
    {
     ...
     */
    protected function contextForms(string $formType): Verify\V2\FormContext
    {
        return $this->v2->forms($formType);
    }

    protected function getServices(): Verify\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid): Verify\V2\ServiceContext
    {
        return $this->v2->services($sid);
    }

    protected function getVerificationAttempts(): Verify\V2\VerificationAttemptList
    {
     ...
     */
    protected function contextVerificationAttempts(string $sid): Verify\V2\VerificationAttemptContext
    {
