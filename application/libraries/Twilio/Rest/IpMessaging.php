...
class IpMessaging extends Domain
{
    ...
    protected function getCredentials(): IpMessaging\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid): IpMessaging\V2\CredentialContext
    {
        return $this->v2->credentials($sid);
    }

    protected function getServices(): IpMessaging\V2\ServiceList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextServices(string $sid): IpMessaging\V2\ServiceContext
    {
