...
class Wireless extends Domain
{
    ...
    protected function getUsageRecords(): Wireless\V1\UsageRecordList
    {
        return $this->v1->usageRecords;
    }

    protected function getCommands(): Wireless\V1\CommandList
    {
     ...
     */
    protected function contextCommands(string $sid): Wireless\V1\CommandContext
    {
        return $this->v1->commands($sid);
    }

    protected function getRatePlans(): Wireless\V1\RatePlanList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRatePlans(string $sid): Wireless\V1\RatePlanContext
    {
        return $this->v1->ratePlans($sid);
    }

    protected function getSims(): Wireless\V1\SimList
    {
        return $this->v1->sims;
    }
     ...
     */
    protected function contextSims(string $sid): Wireless\V1\SimContext
    {
