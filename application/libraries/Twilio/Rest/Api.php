...
class Api extends Domain
{
     ...
     */
    protected function getAccount(): Api\V2010\AccountContext
    {
        return $this->v2010->account;
    }

    protected function getAccounts(): Api\V2010\AccountList
    {
     ...
     */
    protected function contextAccounts(string $sid): Api\V2010\AccountContext
    {
        return $this->v2010->accounts($sid);
    }

    protected function getAddresses(): Api\V2010\Account\AddressList
    {
     ...
     */
    protected function contextAddresses(string $sid): Api\V2010\Account\AddressContext
    {
        return $this->v2010->account->addresses($sid);
    }

    protected function getApplications(): Api\V2010\Account\ApplicationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextApplications(string $sid): Api\V2010\Account\ApplicationContext
    {
        return $this->v2010->account->applications($sid);
    }

    protected function getAuthorizedConnectApps(): Api\V2010\Account\AuthorizedConnectAppList
    {
     ...
     */
    protected function contextAuthorizedConnectApps(string $connectAppSid): Api\V2010\Account\AuthorizedConnectAppContext
    {
        return $this->v2010->account->authorizedConnectApps($connectAppSid);
    }

    protected function getAvailablePhoneNumbers(): Api\V2010\Account\AvailablePhoneNumberCountryList
    {
     ...
     */
    protected function contextAvailablePhoneNumbers(string $countryCode): Api\V2010\Account\AvailablePhoneNumberCountryContext
    {
        return $this->v2010->account->availablePhoneNumbers($countryCode);
    }

    protected function getBalance(): Api\V2010\Account\BalanceList
    {
        return $this->v2010->account->balance;
    }

    protected function getCalls(): Api\V2010\Account\CallList
    {
     ...
     */
    protected function contextCalls(string $sid): Api\V2010\Account\CallContext
    {
        return $this->v2010->account->calls($sid);
    }

    protected function getConferences(): Api\V2010\Account\ConferenceList
    {
     ...
     */
    protected function contextConferences(string $sid): Api\V2010\Account\ConferenceContext
    {
        return $this->v2010->account->conferences($sid);
    }

    protected function getConnectApps(): Api\V2010\Account\ConnectAppList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectApps(string $sid): Api\V2010\Account\ConnectAppContext
    {
        return $this->v2010->account->connectApps($sid);
    }

    protected function getIncomingPhoneNumbers(): Api\V2010\Account\IncomingPhoneNumberList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIncomingPhoneNumbers(string $sid): Api\V2010\Account\IncomingPhoneNumberContext
    {
        return $this->v2010->account->incomingPhoneNumbers($sid);
    }

    protected function getKeys(): Api\V2010\Account\KeyList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextKeys(string $sid): Api\V2010\Account\KeyContext
    {
        return $this->v2010->account->keys($sid);
    }

    protected function getMessages(): Api\V2010\Account\MessageList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextMessages(string $sid): Api\V2010\Account\MessageContext
    {
        return $this->v2010->account->messages($sid);
    }

    protected function getNewKeys(): Api\V2010\Account\NewKeyList
    {
        return $this->v2010->account->newKeys;
    }

    protected function getNewSigningKeys(): Api\V2010\Account\NewSigningKeyList
    {
        return $this->v2010->account->newSigningKeys;
    }

    protected function getNotifications(): Api\V2010\Account\NotificationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextNotifications(string $sid): Api\V2010\Account\NotificationContext
    {
        return $this->v2010->account->notifications($sid);
    }

    protected function getOutgoingCallerIds(): Api\V2010\Account\OutgoingCallerIdList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextOutgoingCallerIds(string $sid): Api\V2010\Account\OutgoingCallerIdContext
    {
        return $this->v2010->account->outgoingCallerIds($sid);
    }

    protected function getQueues(): Api\V2010\Account\QueueList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextQueues(string $sid): Api\V2010\Account\QueueContext
    {
        return $this->v2010->account->queues($sid);
    }

    protected function getRecordings(): Api\V2010\Account\RecordingList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextRecordings(string $sid): Api\V2010\Account\RecordingContext
    {
        return $this->v2010->account->recordings($sid);
    }

    protected function getSigningKeys(): Api\V2010\Account\SigningKeyList
    {
     ...
     */
    protected function contextSigningKeys(string $sid): Api\V2010\Account\SigningKeyContext
    {
        return $this->v2010->account->signingKeys($sid);
    }

    protected function getSip(): Api\V2010\Account\SipList
    {
        return $this->v2010->account->sip;
    }

    protected function getShortCodes(): Api\V2010\Account\ShortCodeList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextShortCodes(string $sid): Api\V2010\Account\ShortCodeContext
    {
        return $this->v2010->account->shortCodes($sid);
    }

    protected function getTokens(): Api\V2010\Account\TokenList
    {
        return $this->v2010->account->tokens;
    }

    protected function getTranscriptions(): Api\V2010\Account\TranscriptionList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextTranscriptions(string $sid): Api\V2010\Account\TranscriptionContext
    {
        return $this->v2010->account->transcriptions($sid);
    }

    protected function getUsage(): Api\V2010\Account\UsageList
    {
        return $this->v2010->account->usage;
    }

    protected function getValidationRequests(): Api\V2010\Account\ValidationRequestList
    {
