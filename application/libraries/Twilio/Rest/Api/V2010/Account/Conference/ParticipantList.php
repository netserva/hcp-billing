...
class ParticipantList extends ListResource
{
    ...
    public function create(string $from, string $to, array $options = []): ParticipantInstance
    {
        ...
        $data = Values::of([
            ...
            'RecordingStatusCallbackEvent' => Serialize::map($options['recordingStatusCallbackEvent'], fn ($e) => $e),
            'ConferenceRecordingStatusCallbackEvent' => Serialize::map($options['conferenceRecordingStatusCallbackEvent'], fn ($e) => $e),
