...
class Events extends Domain
{
    ...
    protected function getEventTypes(): Events\V1\EventTypeList
    {
     ...
     */
    protected function contextEventTypes(string $type): Events\V1\EventTypeContext
    {
        return $this->v1->eventTypes($type);
    }

    protected function getSchemas(): Events\V1\SchemaList
    {
     ...
     */
    protected function contextSchemas(string $id): Events\V1\SchemaContext
    {
        return $this->v1->schemas($id);
    }

    protected function getSinks(): Events\V1\SinkList
    {
     ...
     */
    protected function contextSinks(string $sid): Events\V1\SinkContext
    {
        return $this->v1->sinks($sid);
    }

    protected function getSubscriptions(): Events\V1\SubscriptionList
    {
     ...
     */
    protected function contextSubscriptions(string $sid): Events\V1\SubscriptionContext
    {
