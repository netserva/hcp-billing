...
class Studio extends Domain
{
    ...
    protected function getFlows(): Studio\V2\FlowList
    {
     ...
     */
    protected function contextFlows(string $sid): Studio\V2\FlowContext
    {
        return $this->v2->flows($sid);
    }

    protected function getFlowValidate(): Studio\V2\FlowValidateList
    {
