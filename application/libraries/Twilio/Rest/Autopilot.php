...
class Autopilot extends Domain
{
    ...
    protected function getAssistants(): Autopilot\V1\AssistantList
    {
     ...
     */
    protected function contextAssistants(string $sid): Autopilot\V1\AssistantContext
    {
        return $this->v1->assistants($sid);
    }

    protected function getRestoreAssistant(): Autopilot\V1\RestoreAssistantList
    {
