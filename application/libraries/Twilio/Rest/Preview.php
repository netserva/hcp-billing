...
class Preview extends Domain
{
    ...
    protected function getExports(): Preview\BulkExports\ExportList
    {
     ...
     */
    protected function contextExports(string $resourceType): Preview\BulkExports\ExportContext
    {
        return $this->bulkExports->exports($resourceType);
    }

    protected function getExportConfiguration(): Preview\BulkExports\ExportConfigurationList
    {
     ...
     *                             Conferences, and Participants
     */
    protected function contextExportConfiguration(string $resourceType): Preview\BulkExports\ExportConfigurationContext
    {
        return $this->bulkExports->exportConfiguration($resourceType);
    }

    protected function getFleets(): Preview\DeployedDevices\FleetList
    {
     ...
     */
    protected function contextFleets(string $sid): Preview\DeployedDevices\FleetContext
    {
        return $this->deployedDevices->fleets($sid);
    }

    protected function getAuthorizationDocuments(): Preview\HostedNumbers\AuthorizationDocumentList
    {
     ...
     */
    protected function contextAuthorizationDocuments(string $sid): Preview\HostedNumbers\AuthorizationDocumentContext
    {
        return $this->hostedNumbers->authorizationDocuments($sid);
    }

    protected function getHostedNumberOrders(): Preview\HostedNumbers\HostedNumberOrderList
    {
     ...
     */
    protected function contextHostedNumberOrders(string $sid): Preview\HostedNumbers\HostedNumberOrderContext
    {
        return $this->hostedNumbers->hostedNumberOrders($sid);
    }

    protected function getAvailableAddOns(): Preview\Marketplace\AvailableAddOnList
    {
     ...
     */
    protected function contextAvailableAddOns(string $sid): Preview\Marketplace\AvailableAddOnContext
    {
        return $this->marketplace->availableAddOns($sid);
    }

    protected function getInstalledAddOns(): Preview\Marketplace\InstalledAddOnList
    {
     ...
     */
    protected function contextInstalledAddOns(string $sid): Preview\Marketplace\InstalledAddOnContext
    {
        return $this->marketplace->installedAddOns($sid);
    }

    protected function getServices(): Preview\Sync\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid): Preview\Sync\ServiceContext
    {
        return $this->sync->services($sid);
    }

    protected function getAssistants(): Preview\Understand\AssistantList
    {
     ...
     *                    resource
     */
    protected function contextAssistants(string $sid): Preview\Understand\AssistantContext
    {
        return $this->understand->assistants($sid);
    }

    protected function getCommands(): Preview\Wireless\CommandList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(string $sid): Preview\Wireless\CommandContext
    {
        return $this->wireless->commands($sid);
    }

    protected function getRatePlans(): Preview\Wireless\RatePlanList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(string $sid): Preview\Wireless\RatePlanContext
    {
        return $this->wireless->ratePlans($sid);
    }

    protected function getSims(): Preview\Wireless\SimList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextSims(string $sid): Preview\Wireless\SimContext
    {
        return $this->wireless->sims($sid);
    }

    protected function getBrandedChannels(): Preview\TrustedComms\BrandedChannelList
    {
     ...
     */
    protected function contextBrandedChannels(string $sid): Preview\TrustedComms\BrandedChannelContext
    {
        return $this->trustedComms->brandedChannels($sid);
    }

    protected function getBrandsInformation(): Preview\TrustedComms\BrandsInformationList
    {
        return $this->trustedComms->brandsInformation;
    }

    protected function contextBrandsInformation(): Preview\TrustedComms\BrandsInformationContext
    {
        return $this->trustedComms->brandsInformation();
    }

    protected function getCps(): Preview\TrustedComms\CpsList
    {
        return $this->trustedComms->cps;
    }

    protected function contextCps(): Preview\TrustedComms\CpsContext
    {
        return $this->trustedComms->cps();
    }

    protected function getCurrentCalls(): Preview\TrustedComms\CurrentCallList
    {
        return $this->trustedComms->currentCalls;
    }

    protected function contextCurrentCalls(): Preview\TrustedComms\CurrentCallContext
    {
        return $this->trustedComms->currentCalls();
    }
}
