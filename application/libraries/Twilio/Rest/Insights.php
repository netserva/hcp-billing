...
class Insights extends Domain
{
    ...
    protected function getCalls(): Insights\V1\CallList
    {
     ...
     */
    protected function contextCalls(string $sid): Insights\V1\CallContext
    {
        return $this->v1->calls($sid);
    }

    protected function getRooms(): Insights\V1\RoomList
    {
     ...
     */
    protected function contextRooms(string $roomSid): Insights\V1\RoomContext
    {
