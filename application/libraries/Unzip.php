 ...
 * @author		Don Myers
 *
 * @see		http://bitbucket.org/philsturgeon/codeigniter-unzip
 *
 * @license
 *
 * @version     1.0.0
...
class Unzip
{
     ...
     * @param null|mixed $target_dir
     * @param mixed      $preserve_filepath
     *
     * @return none
     */
     ...
     *
     * @param     bool
     * @param mixed $stop_on_file
     *
     * @return mixed
     */
    private function _list_files($stop_on_file = false)
    {
        if (count($this->compressed_list)) {
     ...
     * @param mixed $compressed_file_name
