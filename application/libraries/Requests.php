...
class Requests
{
    ...
    public static function decompress($data)
    {
        ...
        if (($decoded = self::compatible_gzinflate($data)) !== false) {
            return $decoded;
        }
        if (function_exists('gzuncompress') && ($decoded = @gzuncompress($data)) !== false) {
            return $decoded;
        }
     ...
     *
     * @since 2.8.1
     * @see http://core.trac.wordpress.org/ticket/18273
     * @see http://au2.php.net/manual/en/function.gzinflate.php#70875
    ...
    protected static function parse_response($headers, $url, $req_headers, $req_data, $options)
    {
        ...
        if ((in_array($return->status_code, [300, 301, 302, 303, 307]) || $return->status_code > 307 && $return->status_code < 400) && true === $options['follow_redirects']) {
