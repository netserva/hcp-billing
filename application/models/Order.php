...
class Order extends CI_Model
{
    ...
    public static function list_orders($array)
    {
    ...
    public static function get_domain_order($id)
    {
    ...
    public static function get_resellerclub_ids($domain)
    {
        self::$db->select('*');
    ...
    public static function pending_domains()
    {
        self::$db->select('id');
        self::$db->from('orders');
    ...
    public static function pending_accounts()
    {
        self::$db->select('id');
        self::$db->from('orders');
        self::$db->where('status_id', 5);
    ...
    public static function client_domains($client)
    {
        self::$db->select('id');
        self::$db->from('orders');
    ...
    public static function client_accounts($client)
    {
        self::$db->select('id');
        self::$db->from('orders');
        self::$db->where('client_id', $client);
        self::$db->where(['o_id' => 0]);
        self::$db->where("(type ='hosting')");
    ...
    public static function client_orders($client)
    {
        self::$db->select('*');
        self::$db->from('orders');
        self::$db->join('items', 'orders.item = items.item_id', 'LEFT');
    ...
    public static function unpaid_orders()
    {
    ...
    public static function get_nameservers($id, $domain_servers = null)
    {
    ...
    public static function get_ns($server)
    {
        $nameservers = '';
    ...
    public static function send_account_details($id = null): void
    {
