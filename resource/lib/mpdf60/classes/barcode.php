    ...
    public function setBarcode($code, $type, $pr = ''): void
    {
        ...
        switch (strtoupper($type)) {
            ...
            case 'EAN128C':  // EAN 128 C
                    if ('C128A' == strtoupper($type)) {
                        $arrcode = $this->barcode_c128($code, 'A');
                    }
                    if ('C128B' == strtoupper($type)) {
                        $arrcode = $this->barcode_c128($code, 'B');
                    }
                    if ('C128C' == strtoupper($type)) {
                        $arrcode = $this->barcode_c128($code, 'C');
                    }
                    if ('EAN128A' == strtoupper($type)) {
                        $arrcode = $this->barcode_c128($code, 'A', true);
                    }
                    if ('EAN128B' == strtoupper($type)) {
                        $arrcode = $this->barcode_c128($code, 'B', true);
                    }
                    if ('EAN128C' == strtoupper($type)) {
