...
class directw
{
    ...
    public function Write($h, $txt, $currentx = 0, $link = '', $directionality = 'ltr', $align = ''): void
    {
        if (!$align) {
            if ('rtl' == $directionality) {
                $align = 'R';
            } else {
                $align = 'L';
            }
    ...
    public function CircularText($x, $y, $r, $text, $align = 'top', $fontfamily = '', $fontsizePt = 0, $fontstyle = '', $kerning = 120, $fontwidth = 100, $divider = ''): void
    {
    ...
    public function Shaded_box($text, $font = '', $fontstyle = 'B', $szfont = '', $width = '70%', $style = 'DF', $radius = 2.5, $fill = '#FFFFFF', $color = '#000000', $pad = 2): void
    {
