...
class UCDN
{
    public const SCRIPT_COMMON = 0;
    public const SCRIPT_LATIN = 1;
    public const SCRIPT_GREEK = 2;
    public const SCRIPT_CYRILLIC = 3;
    public const SCRIPT_ARMENIAN = 4;
    public const SCRIPT_HEBREW = 5;
    public const SCRIPT_ARABIC = 6;
    public const SCRIPT_SYRIAC = 7;
    public const SCRIPT_THAANA = 8;
    public const SCRIPT_DEVANAGARI = 9;
    public const SCRIPT_BENGALI = 10;
    public const SCRIPT_GURMUKHI = 11;
    public const SCRIPT_GUJARATI = 12;
    public const SCRIPT_ORIYA = 13;
    public const SCRIPT_TAMIL = 14;
    public const SCRIPT_TELUGU = 15;
    public const SCRIPT_KANNADA = 16;
    public const SCRIPT_MALAYALAM = 17;
    public const SCRIPT_SINHALA = 18;
    public const SCRIPT_THAI = 19;
    public const SCRIPT_LAO = 20;
    public const SCRIPT_TIBETAN = 21;
    public const SCRIPT_MYANMAR = 22;
    public const SCRIPT_GEORGIAN = 23;
    public const SCRIPT_HANGUL = 24;
    public const SCRIPT_ETHIOPIC = 25;
    public const SCRIPT_CHEROKEE = 26;
    public const SCRIPT_CANADIAN_ABORIGINAL = 27;
    public const SCRIPT_OGHAM = 28;
    public const SCRIPT_RUNIC = 29;
    public const SCRIPT_KHMER = 30;
    public const SCRIPT_MONGOLIAN = 31;
    public const SCRIPT_HIRAGANA = 32;
    public const SCRIPT_KATAKANA = 33;
    public const SCRIPT_BOPOMOFO = 34;
    public const SCRIPT_HAN = 35;
    public const SCRIPT_YI = 36;
    public const SCRIPT_OLD_ITALIC = 37;
    public const SCRIPT_GOTHIC = 38;
    public const SCRIPT_DESERET = 39;
    public const SCRIPT_INHERITED = 40;
    public const SCRIPT_TAGALOG = 41;
    public const SCRIPT_HANUNOO = 42;
    public const SCRIPT_BUHID = 43;
    public const SCRIPT_TAGBANWA = 44;
    public const SCRIPT_LIMBU = 45;
    public const SCRIPT_TAI_LE = 46;
    public const SCRIPT_LINEAR_B = 47;
    public const SCRIPT_UGARITIC = 48;
    public const SCRIPT_SHAVIAN = 49;
    public const SCRIPT_OSMANYA = 50;
    public const SCRIPT_CYPRIOT = 51;
    public const SCRIPT_BRAILLE = 52;
    public const SCRIPT_BUGINESE = 53;
    public const SCRIPT_COPTIC = 54;
    public const SCRIPT_NEW_TAI_LUE = 55;
    public const SCRIPT_GLAGOLITIC = 56;
    public const SCRIPT_TIFINAGH = 57;
    public const SCRIPT_SYLOTI_NAGRI = 58;
    public const SCRIPT_OLD_PERSIAN = 59;
    public const SCRIPT_KHAROSHTHI = 60;
    public const SCRIPT_BALINESE = 61;
    public const SCRIPT_CUNEIFORM = 62;
    public const SCRIPT_PHOENICIAN = 63;
    public const SCRIPT_PHAGS_PA = 64;
    public const SCRIPT_NKO = 65;
    public const SCRIPT_SUNDANESE = 66;
    public const SCRIPT_LEPCHA = 67;
    public const SCRIPT_OL_CHIKI = 68;
    public const SCRIPT_VAI = 69;
    public const SCRIPT_SAURASHTRA = 70;
    public const SCRIPT_KAYAH_LI = 71;
    public const SCRIPT_REJANG = 72;
    public const SCRIPT_LYCIAN = 73;
    public const SCRIPT_CARIAN = 74;
    public const SCRIPT_LYDIAN = 75;
    public const SCRIPT_CHAM = 76;
    public const SCRIPT_TAI_THAM = 77;
    public const SCRIPT_TAI_VIET = 78;
    public const SCRIPT_AVESTAN = 79;
    public const SCRIPT_EGYPTIAN_HIEROGLYPHS = 80;
    public const SCRIPT_SAMARITAN = 81;
    public const SCRIPT_LISU = 82;
    public const SCRIPT_BAMUM = 83;
    public const SCRIPT_JAVANESE = 84;
    public const SCRIPT_MEETEI_MAYEK = 85;
    public const SCRIPT_IMPERIAL_ARAMAIC = 86;
    public const SCRIPT_OLD_SOUTH_ARABIAN = 87;
    public const SCRIPT_INSCRIPTIONAL_PARTHIAN = 88;
    public const SCRIPT_INSCRIPTIONAL_PAHLAVI = 89;
    public const SCRIPT_OLD_TURKIC = 90;
    public const SCRIPT_KAITHI = 91;
    public const SCRIPT_BATAK = 92;
    public const SCRIPT_BRAHMI = 93;
    public const SCRIPT_MANDAIC = 94;
    public const SCRIPT_CHAKMA = 95;
    public const SCRIPT_MEROITIC_CURSIVE = 96;
    public const SCRIPT_MEROITIC_HIEROGLYPHS = 97;
    public const SCRIPT_MIAO = 98;
    public const SCRIPT_SHARADA = 99;
    public const SCRIPT_SORA_SOMPENG = 100;
    public const SCRIPT_TAKRI = 101;
    public const SCRIPT_UNKNOWN = 102;

    // hb-unicode.h
    public const UNICODE_GENERAL_CATEGORY_CONTROL = 0;   // Cc
    public const UNICODE_GENERAL_CATEGORY_FORMAT = 1;   // Cf
    public const UNICODE_GENERAL_CATEGORY_UNASSIGNED = 2;   // Cn
    public const UNICODE_GENERAL_CATEGORY_PRIVATE_USE = 3;   // Co
    public const UNICODE_GENERAL_CATEGORY_SURROGATE = 4;   // Cs
    public const UNICODE_GENERAL_CATEGORY_LOWERCASE_LETTER = 5;  // Ll
    public const UNICODE_GENERAL_CATEGORY_MODIFIER_LETTER = 6;  // Lm
    public const UNICODE_GENERAL_CATEGORY_OTHER_LETTER = 7;  // Lo
    public const UNICODE_GENERAL_CATEGORY_TITLECASE_LETTER = 8;  // Lt
    public const UNICODE_GENERAL_CATEGORY_UPPERCASE_LETTER = 9;  // Lu
    public const UNICODE_GENERAL_CATEGORY_SPACING_MARK = 10;  // Mc
    public const UNICODE_GENERAL_CATEGORY_ENCLOSING_MARK = 11;  // Me
    public const UNICODE_GENERAL_CATEGORY_NON_SPACING_MARK = 12;  // Mn
    public const UNICODE_GENERAL_CATEGORY_DECIMAL_NUMBER = 13;  // Nd
    public const UNICODE_GENERAL_CATEGORY_LETTER_NUMBER = 14;  // Nl
    public const UNICODE_GENERAL_CATEGORY_OTHER_NUMBER = 15;  // No
    public const UNICODE_GENERAL_CATEGORY_CONNECT_PUNCTUATION = 16; // Pc
    public const UNICODE_GENERAL_CATEGORY_DASH_PUNCTUATION = 17;  // Pd
    public const UNICODE_GENERAL_CATEGORY_CLOSE_PUNCTUATION = 18; // Pe
    public const UNICODE_GENERAL_CATEGORY_FINAL_PUNCTUATION = 19; // Pf
    public const UNICODE_GENERAL_CATEGORY_INITIAL_PUNCTUATION = 20; // Pi
    public const UNICODE_GENERAL_CATEGORY_OTHER_PUNCTUATION = 21; // Po
    public const UNICODE_GENERAL_CATEGORY_OPEN_PUNCTUATION = 22;  // Ps
    public const UNICODE_GENERAL_CATEGORY_CURRENCY_SYMBOL = 23;  // Sc
    public const UNICODE_GENERAL_CATEGORY_MODIFIER_SYMBOL = 24;  // Sk
    public const UNICODE_GENERAL_CATEGORY_MATH_SYMBOL = 25;  // Sm
    public const UNICODE_GENERAL_CATEGORY_OTHER_SYMBOL = 26;  // So
    public const UNICODE_GENERAL_CATEGORY_LINE_SEPARATOR = 27;  // Zl
    public const UNICODE_GENERAL_CATEGORY_PARAGRAPH_SEPARATOR = 28; // Zp
    public const UNICODE_GENERAL_CATEGORY_SPACE_SEPARATOR = 29;  // Zs

    public const BIDI_CLASS_L = 0;
    public const BIDI_CLASS_LRE = 1;
    public const BIDI_CLASS_LRO = 2;
    public const BIDI_CLASS_R = 3;
    public const BIDI_CLASS_AL = 4;
    public const BIDI_CLASS_RLE = 5;
    public const BIDI_CLASS_RLO = 6;
    public const BIDI_CLASS_PDF = 7;
    public const BIDI_CLASS_EN = 8;
    public const BIDI_CLASS_ES = 9;
    public const BIDI_CLASS_ET = 10;
    public const BIDI_CLASS_AN = 11;
    public const BIDI_CLASS_CS = 12;
    public const BIDI_CLASS_NSM = 13;
    public const BIDI_CLASS_BN = 14;
    public const BIDI_CLASS_B = 15;
    public const BIDI_CLASS_S = 16;
    public const BIDI_CLASS_WS = 17;
    public const BIDI_CLASS_ON = 18;
    ...
    {
        if (UNICODE_GENERAL_CATEGORY_SPACING_MARK == $gen_cat || UNICODE_GENERAL_CATEGORY_ENCLOSING_MARK == $gen_cat
            || UNICODE_GENERAL_CATEGORY_NON_SPACING_MARK == $gen_cat) {
            return true;
        }
