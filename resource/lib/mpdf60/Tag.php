...
class Tag
{
    ...
    public function OpenTag($tag, $attr, &$ahtml, &$ihtml): void
    { // mPDF 6
        //Opening tag
        // mPDF 6
        ...
        if ($this->mpdf->allow_html_optional_endtags) {
            if (isset($this->mpdf->blk[$this->mpdf->blklvl]['tag'])) {
                ...
                if (!$closed && 'P' == $this->mpdf->blk[$this->mpdf->blklvl]['tag'] && ('P' == $tag || 'DIV' == $tag || 'H1' == $tag || 'H2' == $tag || 'H3' == $tag || 'H4' == $tag || 'H5' == $tag || 'H6' == $tag || 'UL' == $tag || 'OL' == $tag || 'TABLE' == $tag || 'PRE' == $tag || 'FORM' == $tag || 'ADDRESS' == $tag || 'BLOCKQUOTE' == $tag || 'CENTER' == $tag || 'DL' == $tag || 'HR' == $tag || 'ARTICLE' == $tag || 'ASIDE' == $tag || 'FIELDSET' == $tag || 'HGROUP' == $tag || 'MAIN' == $tag || 'NAV' == $tag || 'SECTION' == $tag)) {
                ...
                if (!$closed && 'OPTION' == $this->mpdf->blk[$this->mpdf->blklvl]['tag'] && 'OPTION' == $tag) {
                    $this->CloseTag('OPTION', $ahtml, $ihtml);
                    $closed = true;
                }
                // Table elements - see also WriteHTML()
                if (!$closed && ('TD' == $tag || 'TH' == $tag) && 'TD' == $this->mpdf->lastoptionaltag) {
                    $this->CloseTag($this->mpdf->lastoptionaltag, $ahtml, $ihtml);
                    $closed = true;
                } // *TABLES*
                if (!$closed && ('TD' == $tag || 'TH' == $tag) && 'TH' == $this->mpdf->lastoptionaltag) {
                    $this->CloseTag($this->mpdf->lastoptionaltag, $ahtml, $ihtml);
                    $closed = true;
                } // *TABLES*
                if (!$closed && 'TR' == $tag && 'TR' == $this->mpdf->lastoptionaltag) {
                    $this->CloseTag($this->mpdf->lastoptionaltag, $ahtml, $ihtml);
                    $closed = true;
                } // *TABLES*
                if (!$closed && 'TR' == $tag && 'TD' == $this->mpdf->lastoptionaltag) {
                    $this->CloseTag($this->mpdf->lastoptionaltag, $ahtml, $ihtml);
                    $this->CloseTag('TR', $ahtml, $ihtml);
                    $this->CloseTag('THEAD', $ahtml, $ihtml);
                    $closed = true;
                } // *TABLES*
                if (!$closed && 'TR' == $tag && 'TH' == $this->mpdf->lastoptionaltag) {
                    $this->CloseTag($this->mpdf->lastoptionaltag, $ahtml, $ihtml);
                    $this->CloseTag('TR', $ahtml, $ihtml);
                    $this->CloseTag('THEAD', $ahtml, $ihtml);
                    $closed = true;
        ...
        switch ($tag) {
            ...
            case 'PAGEFOOTER':
                ...
                if (isset($attr['HEADER-STYLE']) || isset($attr['FOOTER-STYLE'])) { // font-family,size,weight,style,color
                    ...
                    if (isset($properties['FONT-WEIGHT']) && 'bold' == $properties['FONT-WEIGHT']) {
                        $p['L']['font-style'] = 'B';
                        $p['C']['font-style'] = 'B';
                        $p['R']['font-style'] = 'B';
                    }
                    if (isset($properties['FONT-STYLE']) && 'italic' == $properties['FONT-STYLE']) {
                        $p['L']['font-style'] .= 'I';
                        $p['C']['font-style'] .= 'I';
                        $p['R']['font-style'] .= 'I';
                    }
                ...
                if (isset($attr['LINE']) && $attr['LINE']) { // 0|1|on|off
                    if ('1' == $attr['LINE'] || 'ON' == strtoupper($attr['LINE'])) {
                        $lineset = 1;
                    } else {
                        $lineset = 0;
                    }
            ...
            case 'SETHTMLPAGEFOOTER':
                ...
                if (isset($attr['NAME']) && $attr['NAME']) {
                    $pname = $attr['NAME'];
                } elseif ('SETPAGEHEADER' == $tag || 'SETPAGEFOOTER' == $tag) {
                    $pname = '_nonhtmldefault';
                } // mPDF 6
                else {
                    $pname = '_default';
                ...
                if (isset($attr['PAGE']) && $attr['PAGE']) {  // O|odd|even|E|ALL|[blank]
                    if ('O' == strtoupper($attr['PAGE']) || 'ODD' == strtoupper($attr['PAGE'])) {
                        $side = 'odd';
                    } elseif ('E' == strtoupper($attr['PAGE']) || 'EVEN' == strtoupper($attr['PAGE'])) {
                        $side = 'even';
                    } elseif ('ALL' == strtoupper($attr['PAGE'])) {
                        $side = 'both';
                    } else {
                        $side = 'odd';
                    }
                ...
                if (isset($attr['VALUE']) && $attr['VALUE']) {  // -1|1|on|off
                    if ('1' == $attr['VALUE'] || 'ON' == strtoupper($attr['VALUE'])) {
                        $set = 1;
                    } elseif ('-1' == $attr['VALUE'] || 'OFF' == strtoupper($attr['VALUE'])) {
                        $set = 0;
                    } else {
                        $set = 1;
                    }
                ...
                if (isset($attr['SHOW-THIS-PAGE']) && $attr['SHOW-THIS-PAGE'] && ('SETHTMLPAGEHEADER' == $tag || 'SETPAGEHEADER' == $tag)) {
                    $write = 1;
                } else {
                    $write = 0;
                }
                if ('odd' == $side || 'both' == $side) {
                    if ($set && ('SETHTMLPAGEHEADER' == $tag || 'SETPAGEHEADER' == $tag)) {
                        $this->mpdf->SetHTMLHeader($this->mpdf->pageHTMLheaders[$pname], 'O', $write);
                    } elseif ($set && ('SETHTMLPAGEFOOTER' == $tag || 'SETPAGEFOOTER' == $tag)) {
                        $this->mpdf->SetHTMLFooter($this->mpdf->pageHTMLfooters[$pname], 'O');
                    } elseif ('SETHTMLPAGEHEADER' == $tag || 'SETPAGEHEADER' == $tag) {
                        $this->mpdf->SetHTMLHeader('', 'O');
                    } else {
                        $this->mpdf->SetHTMLFooter('', 'O');
                    }
                }
                if ('even' == $side || 'both' == $side) {
                    if ($set && ('SETHTMLPAGEHEADER' == $tag || 'SETPAGEHEADER' == $tag)) {
            ...
            case 'FORMFEED': //custom-tag
                ...
                if (isset($attr['ODD-HEADER-VALUE']) && ('1' == $attr['ODD-HEADER-VALUE'] || 'ON' == strtoupper($attr['ODD-HEADER-VALUE']))) {
                    $ohvalue = 1;
                } elseif (isset($attr['ODD-HEADER-VALUE']) && ('-1' == $attr['ODD-HEADER-VALUE'] || 'OFF' == strtoupper($attr['ODD-HEADER-VALUE']))) {
                    $ohvalue = -1;
                }
                if (isset($attr['EVEN-HEADER-VALUE']) && ('1' == $attr['EVEN-HEADER-VALUE'] || 'ON' == strtoupper($attr['EVEN-HEADER-VALUE']))) {
                    $ehvalue = 1;
                } elseif (isset($attr['EVEN-HEADER-VALUE']) && ('-1' == $attr['EVEN-HEADER-VALUE'] || 'OFF' == strtoupper($attr['EVEN-HEADER-VALUE']))) {
                    $ehvalue = -1;
                }
                if (isset($attr['ODD-FOOTER-VALUE']) && ('1' == $attr['ODD-FOOTER-VALUE'] || 'ON' == strtoupper($attr['ODD-FOOTER-VALUE']))) {
                    $ofvalue = 1;
                } elseif (isset($attr['ODD-FOOTER-VALUE']) && ('-1' == $attr['ODD-FOOTER-VALUE'] || 'OFF' == strtoupper($attr['ODD-FOOTER-VALUE']))) {
                    $ofvalue = -1;
                }
                if (isset($attr['EVEN-FOOTER-VALUE']) && ('1' == $attr['EVEN-FOOTER-VALUE'] || 'ON' == strtoupper($attr['EVEN-FOOTER-VALUE']))) {
                    $efvalue = 1;
                } elseif (isset($attr['EVEN-FOOTER-VALUE']) && ('-1' == $attr['EVEN-FOOTER-VALUE'] || 'OFF' == strtoupper($attr['EVEN-FOOTER-VALUE']))) {
                    $efvalue = -1;
                }

                if (isset($attr['ORIENTATION']) && ('L' == strtoupper($attr['ORIENTATION']) || 'LANDSCAPE' == strtoupper($attr['ORIENTATION']))) {
                    $orient = 'L';
                } elseif (isset($attr['ORIENTATION']) && ('P' == strtoupper($attr['ORIENTATION']) || 'PORTRAIT' == strtoupper($attr['ORIENTATION']))) {
                    $orient = 'P';
                } else {
                ...
                if (isset($attr['PAGE-BREAK-TYPE'])) {
                    if ('cloneall' == strtolower($attr['PAGE-BREAK-TYPE']) || 'clonebycss' == strtolower($attr['PAGE-BREAK-TYPE']) || 'slice' == strtolower($attr['PAGE-BREAK-TYPE'])) {
            ...
            case 'INDEXINSERT':
                ...
                if (isset($attr['USEDIVLETTERS']) && ('OFF' == strtoupper($attr['USEDIVLETTERS']) || -1 == $attr['USEDIVLETTERS'] || '0' === $attr['USEDIVLETTERS'])) {
                    $usedivletters = 0;
                } else {
                    $usedivletters = 1;
                }
                if (isset($attr['LINKS']) && ('ON' == strtoupper($attr['LINKS']) || 1 == $attr['LINKS'])) {
                    $links = true;
                } else {
                    $links = false;
                }
            ...
            case 'COLUMNS': //added custom-tag
                if (isset($attr['COLUMN-COUNT']) && ($attr['COLUMN-COUNT'] || '0' === $attr['COLUMN-COUNT'])) {
            ...
            case 'SPAN':
                ...
                if ($this->mpdf->tableLevel && isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['direction']) && 'rtl' == $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['direction']) {
                    $currdir = 'rtl';
                }
                ...
                if ('BDO' == $tag) {
                    if (isset($attr['DIR']) and 'rtl' == strtolower($attr['DIR'])) {
                        $bdf = 0x202E;
                        $popd = 'RLOPDF';
                    } // U+202E RLO
                    elseif (isset($attr['DIR']) and 'ltr' == strtolower($attr['DIR'])) {
                        $bdf = 0x202D;
                        $popd = 'LROPDF';
                    } // U+202D LRO
                } elseif ('BDI' == $tag) {
                ...
                } elseif (isset($properties['UNICODE-BIDI']) && 'bidi-override' == strtolower($properties['UNICODE-BIDI'])) {
                    if ('rtl' == $currdir) {
                        $bdf = 0x202E;
                        $popd = 'RLOPDF';
                    } // U+202E RLO
                ...
                } elseif (isset($properties['UNICODE-BIDI']) && 'embed' == strtolower($properties['UNICODE-BIDI'])) {
                    if ('rtl' == $currdir) {
                        $bdf = 0x202B;
                        $popd = 'RLEPDF';
                    } // U+202B RLE
                ...
                } elseif (isset($properties['UNICODE-BIDI']) && 'isolate' == strtolower($properties['UNICODE-BIDI'])) {
                    if ('rtl' == $currdir) {
                        $bdf = 0x2067;
                        $popd = 'RLIPDI';
                    } // U+2067 RLI
                ...
                } elseif (isset($properties['UNICODE-BIDI']) && 'isolate-override' == strtolower($properties['UNICODE-BIDI'])) {
                    if ('rtl' == $currdir) {
                        $bdf = 0x2067;
                        $bdf2 = 0x202E;
                        $popd = 'RLIRLOPDFPDI';
                ...
                } elseif (isset($properties['UNICODE-BIDI']) && 'plaintext' == strtolower($properties['UNICODE-BIDI'])) {
                    $bdf = 0x2068;
            ...
            case 'METER':
                ...
                if (isset($attr['MIN']) && $attr['MIN'] && 'METER' == $tag) {
                    $min = $attr['MIN'];
                } else {
                    $min = 0;
                }
                ...
                if (isset($attr['VALUE']) && ($attr['VALUE'] || '0' === $attr['VALUE'])) {
                    $value = $attr['VALUE'];
                    if ($value < $min) {
                        $value = $min;
                    } elseif ($value > $max) {
                ...
                $properties = $this->mpdf->cssmgr->MergeCSS('INLINE', $tag, $attr);
                if (isset($properties['DISPLAY']) && 'none' == strtolower($properties['DISPLAY'])) {
                    return;
                }
                $objattr['visibility'] = 'visible';
                if (isset($properties['VISIBILITY'])) {
                    $v = strtolower($properties['VISIBILITY']);
                    if (('hidden' == $v || 'printonly' == $v || 'screenonly' == $v) && 'visible' == $this->mpdf->visibility) {
                ...
                if ($this->mpdf->HREF) {
                    if (!str_contains($this->mpdf->HREF, '.') && !str_starts_with($this->mpdf->HREF, '@')) {
                        $href = $this->mpdf->HREF;
                ...
                //Save to local file
                $srcpath = _MPDF_TEMP_PATH.'_tempSVG'.uniqid(random_int(1, 100000), true).'_'.strtolower($tag).'.svg';
            ...
            case 'MAIN':
                ...
                if (isset($p['DISPLAY']) && 'none' == strtolower($p['DISPLAY'])) {
                    ++$this->mpdf->blklvl;
                ...
                if ('CAPTION' == $tag) {
                    ...
                    if (isset($attr['POSITION']) && 'bottom' == strtolower($attr['POSITION'])) {
                        $divpos = 'B';
                    } else {
                        $divpos = 'T';
                    }
                    if (isset($attr['ALIGN']) && 'bottom' == strtolower($attr['ALIGN'])) {
                        $cappos = 'B';
                    } elseif (isset($p['CAPTION-SIDE']) && 'bottom' == strtolower($p['CAPTION-SIDE'])) {
                        $cappos = 'B';
                    } else {
                        $cappos = 'T';
                    }
                ...
                // -- FORMS --
                if ('FORM' == $tag) {
                    if (isset($attr['METHOD']) && 'get' == strtolower($attr['METHOD'])) {
                ...
                // -- CSS-POSITION --
                if ((isset($p['POSITION']) && ('fixed' == strtolower($p['POSITION']) || 'absolute' == strtolower($p['POSITION']))) && 0 == $this->mpdf->blklvl) {
                ...
                if ($this->mpdf->tableLevel) {
                    ...
                    if ('CENTER' == $tag && $this->mpdf->tdbegin) {
                    ...
                    if ('UL' == $tag || 'OL' == $tag) {
                        ...
                        if ('OL' == $tag) {
                            ...
                            if (1 == $this->mpdf->listlvl % 3) {
                                $this->mpdf->listtype[$this->mpdf->listlvl] = 'disc';
                            } elseif (2 == $this->mpdf->listlvl % 3) {
                    ...
                    if ('LI' == $tag) {
                        if (0 == $this->mpdf->listlvl) { //in case of malformed HTML code. Example:(...)</p><li>Content</li><p>Paragraph1</p>(...)
                        ...
                        switch ($this->mpdf->listtype[$this->mpdf->listlvl]) {
                            ...
                            default:
                                if (1 == $this->mpdf->listlvl % 3 && $this->mpdf->_charDefined($this->mpdf->CurrentFont['cw'], 8226)) {
                                    $blt = "\xe2\x80\xa2";
                                }  // &#8226;
                                elseif (2 == $this->mpdf->listlvl % 3 && $this->mpdf->_charDefined($this->mpdf->CurrentFont['cw'], 9900)) {
                                    $blt = "\xe2\x9a\xac";
                                } // &#9900;
                                elseif (0 == $this->mpdf->listlvl % 3 && $this->mpdf->_charDefined($this->mpdf->CurrentFont['cw'], 9642)) {
                                    $blt = "\xe2\x96\xaa";
                                } // &#9642;
                                else {
                                    $blt = '-';
                ...
                if (1 == $this->mpdf->lastblocklevelchange) {
                    $blockstate = 1;
                ...
                if (isset($properties['PAGE-BREAK-INSIDE']) && 'AVOID' == strtoupper($properties['PAGE-BREAK-INSIDE']) && !$this->mpdf->ColActive && !$this->mpdf->keep_block_together && !isset($attr['PAGEBREAKAVOIDCHECKED'])) { // avoid re-iterating using PAGEBREAKAVOIDCHECKED; set in CloseTag
                ...
                if (isset($properties['Z-INDEX']) && 0 == $this->mpdf->current_layer) {
                ...
                if (isset($properties['VISIBILITY'])) {
                    $v = strtolower($properties['VISIBILITY']);
                    if (('hidden' == $v || 'printonly' == $v || 'screenonly' == $v) && 'visible' == $this->mpdf->visibility && !$this->mpdf->tableLevel) {
                ...
                // -- CSS-FLOAT --
                if (isset($properties['FLOAT']) && 'RIGHT' == strtoupper($properties['FLOAT']) && !$this->mpdf->ColActive) {
                ...
                } elseif (isset($properties['FLOAT']) && 'LEFT' == strtoupper($properties['FLOAT']) && !$this->mpdf->ColActive) {
                    // Cancel Keep-Block-together
                    $currblk['keep_block_together'] = false;
                    $this->mpdf->kt_y00 = '';
                    $this->mpdf->keep_block_together = 0;
                ...
                if ($cbti < 0) {
                    $hangind = -($cbti);
                    if (isset($currblk['direction']) && 'rtl' == $currblk['direction']) { // *OTL*
                ...
                if (isset($currblk['css_set_width'])) {
                    if (isset($properties['MARGIN-LEFT'], $properties['MARGIN-RIGHT']) && 'auto' == strtolower($properties['MARGIN-LEFT']) && 'auto' == strtolower($properties['MARGIN-RIGHT'])) {
                    ...
                    } elseif (isset($properties['MARGIN-LEFT']) && 'auto' == strtolower($properties['MARGIN-LEFT'])) {
                    ...
                    } elseif (isset($properties['MARGIN-RIGHT']) && 'auto' == strtolower($properties['MARGIN-RIGHT'])) {
                ...
                if ('OL' == $tag || 'UL' == $tag) {
                    ...
                    if ('mpdf' == strtolower($this->mpdf->list_auto_mode) && isset($currblk['list_style_position']) && 'outside' == $currblk['list_style_position'] && isset($currblk['list_style_image']) && 'none' == $currblk['list_style_image'] && (!isset($currblk['list_style_type']) || !preg_match('/U\+([a-fA-F0-9]+)/i', $currblk['list_style_type']))) {
                        ...
                        if (isset($properties['PADDING-RIGHT']) && 'auto' == $properties['PADDING-RIGHT'] && isset($currblk['direction']) && 'rtl' == $currblk['direction']) {
                            $currblk['padding_right'] = $autopadding;
                        } elseif (isset($properties['PADDING-LEFT']) && 'auto' == $properties['PADDING-LEFT']) {
                ...
                // mPDF 6 bidi
                // cf. http://www.w3.org/TR/css3-writing-modes/#unicode-bidi
                if (isset($properties['UNICODE-BIDI']) && ('bidi-override' == strtolower($properties['UNICODE-BIDI']) || 'isolate-override' == strtolower($properties['UNICODE-BIDI']))) {
                    if ('rtl' == $currdir) {
                        $bdf = 0x202E;
                        $popd = 'RLOPDF';
                    } // U+202E RLO
            ...
            case 'HR':
                ...
                if (isset($properties['MARGIN-LEFT']) && 'auto' == strtolower($properties['MARGIN-LEFT'])) {
                    $objattr['align'] = 'R';
                }
                if (isset($properties['MARGIN-RIGHT']) && 'auto' == strtolower($properties['MARGIN-RIGHT'])) {
                    $objattr['align'] = 'L';
                    if (isset($properties['MARGIN-RIGHT']) && 'auto' == strtolower($properties['MARGIN-RIGHT']) && isset($properties['MARGIN-LEFT']) && 'auto' == strtolower($properties['MARGIN-LEFT'])) {
                        $objattr['align'] = 'C';
                    }
                }
                if (isset($properties['COLOR'])) {
            ...
            case 'BARCODE':
                ...
                if (isset($attr['CODE']) && $attr['CODE']) {
                    ...
                    if (isset($attr['TEXT']) && 1 == $attr['TEXT']) {
                        $objattr['showtext'] = 1;
                    } else {
                        $objattr['showtext'] = 0;
                    }
                    ...
                    if ('EAN13' == $objattr['btype'] || 'ISBN' == $objattr['btype'] || 'ISSN' == $objattr['btype'] || 'UPCA' == $objattr['btype'] || 'UPCE' == $objattr['btype'] || 'EAN8' == $objattr['btype']) {
                        $code = preg_replace('/\-/', '', $objattr['code']);
                        if ('ISSN' == $objattr['btype'] || 'ISBN' == $objattr['btype']) {
                        ...
                        if (2 == $objattr['bsupp'] || 5 == $objattr['bsupp']) { // EAN-2 or -5 Supplement
                        ...
                        if (($objattr['showtext'] && 'EAN13' == $objattr['btype']) || 'ISBN' == $objattr['btype'] || 'ISSN' == $objattr['btype']) {
                    ...
                    // QR-code
                    elseif ('QR' == $objattr['btype']) {
                        $w = $h = $objattr['bsize'] * 25; // Factor of 25mm (default)
                        $objattr['errorlevel'] = 'L';
                        if (isset($attr['ERROR'])) {
                            $objattr['errorlevel'] = $attr['ERROR'];
                        }
                    } elseif ('IMB' == $objattr['btype'] || 'RM4SCC' == $objattr['btype'] || 'KIX' == $objattr['btype'] || 'POSTNET' == $objattr['btype'] || 'PLANET' == $objattr['btype']) {
                    ...
                    if (!$this->mpdf->ColActive && !$this->mpdf->tableLevel && !$this->mpdf->listlvl && !$this->mpdf->kwt) {
                        if (isset($properties['FLOAT']) && ('RIGHT' == strtoupper($properties['FLOAT']) || 'LEFT' == strtoupper($properties['FLOAT']))) {
            ...
            case 'SELECT':
                ...
                if (isset($attr['SPELLCHECK']) && 'true' == strtolower($attr['SPELLCHECK'])) {
            ...
            case 'TEXTAREA':
                ...
                if ($this->mpdf->useActiveForms) {
                    ...
                    if (isset($properties['OVERFLOW']) && 'hidden' == strtolower($properties['OVERFLOW'])) {
            ...
            case 'INPUT':
                ...
                switch (strtoupper($attr['TYPE'])) {
                    ...
                    default:
                        ...
                        if ('PASSWORD' == strtoupper($attr['TYPE'])) {
                            $type = 'PASSWORD';
                        }
                        if (isset($attr['VALUE'])) {
                            if ('PASSWORD' == $type) {
            ...
            case 'JPGRAPH':
                ...
                if (!is_array($this->mpdf->graphs[$gid]) || 0 == count($this->mpdf->graphs[$gid])) {
                    break;
                }
                $this->mpdf->ignorefollowingspaces = false;
                ...
                if ($graph_img) {
                    if (isset($attr['ROTATE'])) {
                        if (90 == $attr['ROTATE'] || -90 == $attr['ROTATE']) {
                            $tmpw = $graph_img['w'];
            ...
            case 'IMG':
                ...
                if (isset($attr['SRC'])) {
                    ...
                    if (isset($properties['IMAGE-RENDERING']) && $properties['IMAGE-RENDERING']) {
                        if ('crisp-edges' == strtolower($properties['IMAGE-RENDERING'])) {
                            $interpolation = false;
                        } elseif ('optimizequality' == strtolower($properties['IMAGE-RENDERING'])) {
                            $interpolation = true;
                        } elseif ('smooth' == strtolower($properties['IMAGE-RENDERING'])) {
                            $interpolation = true;
                        } elseif ('auto' == strtolower($properties['IMAGE-RENDERING'])) {
                    ...
                    if ($image_orientation) {
                        if (90 == $image_orientation || -90 == $image_orientation || 270 == $image_orientation) {
                            $tmpw = $info['w'];
                            $info['w'] = $info['h'];
                            $info['h'] = $tmpw;
                        }
            ...
            case 'TEXTCIRCLE':
                ...
                if (isset($properties['FONT-SIZE'])) {
                    if ('auto' == strtolower($properties['FONT-SIZE'])) {
                ...
                if (isset($properties['FONT-WEIGHT'])) {
                    if ('BOLD' == strtoupper($properties['FONT-WEIGHT'])) {
                        $objattr['fontstyle'] .= 'B';
                    }
                }
                if (isset($properties['FONT-STYLE'])) {
                    if ('ITALIC' == strtoupper($properties['FONT-STYLE'])) {
                        $objattr['fontstyle'] .= 'I';
                    }
                }
            ...
            case 'TABLE': // TABLE-BEGIN
                ...
                if (0 == count($this->mpdf->textbuffer) && 1 == $this->mpdf->lastblocklevelchange && !$this->mpdf->tableLevel && !$this->mpdf->kwt) {
                ...
                if ($this->mpdf->blockjustfinished && !count($this->mpdf->textbuffer) && $this->mpdf->y != $this->mpdf->tMargin && $this->mpdf->collapseBlockMargins && 1 == $this->mpdf->tableLevel) {
                    $lastbottommargin = $this->mpdf->lastblockbottommargin;
                } else {
                    $lastbottommargin = 0;
                }
                ...
                if (1 == $this->mpdf->cssmgr->tbCSSlvl) {
                ...
                if (isset($attr['ALIGN'], $align[strtolower($attr['ALIGN'])])) {
                    $table['a'] = $align[strtolower($attr['ALIGN'])];
                }
                if (!$table['a']) {
                    if ('rtl' == $table['direction']) {
                        $table['a'] = 'R';
                    } else {
                        $table['a'] = 'L';
                    }
                ...
                if (isset($properties['VERTICAL-ALIGN'], $align[strtolower($properties['VERTICAL-ALIGN'])])) {
                    $table['va'] = $align[strtolower($properties['VERTICAL-ALIGN'])];
                }
                if (isset($properties['TEXT-ALIGN'], $align[strtolower($properties['TEXT-ALIGN'])])) {
                    $table['txta'] = $align[strtolower($properties['TEXT-ALIGN'])];
                }

                if (isset($properties['AUTOSIZE']) && $properties['AUTOSIZE'] && 1 == $this->mpdf->tableLevel) {
                ...
                if (isset($properties['ROTATE']) && $properties['ROTATE'] && 1 == $this->mpdf->tableLevel) {
                ...
                if (isset($properties['LANG']) && $properties['LANG']) {
                    if ($this->mpdf->autoLangToFont && !$this->mpdf->usingCoreFont) {
                        if ($properties['LANG'] != $this->mpdf->default_lang && 'UTF-8' != $properties['LANG']) {
                ...
                } elseif (1 == $this->mpdf->tableLevel && isset($this->mpdf->blk[$this->mpdf->blklvl]['line_stacking_strategy'])) {
                ...
                } elseif (1 == $this->mpdf->tableLevel && isset($this->mpdf->blk[$this->mpdf->blklvl]['line_stacking_shift'])) {
                ...
                if (isset($properties['BORDER-COLLAPSE']) && 'SEPARATE' == strtoupper($properties['BORDER-COLLAPSE'])) {
                ...
                if (isset($properties['PAGE-BREAK-INSIDE']) && 'AVOID' == strtoupper($properties['PAGE-BREAK-INSIDE']) && 1 == $this->mpdf->tableLevel && !$this->mpdf->writingHTMLfooter) {
                    $this->mpdf->table_keep_together = true;
                } elseif (1 == $this->mpdf->tableLevel) {
                    $this->mpdf->table_keep_together = false;
                }
                if (isset($properties['PAGE-BREAK-AFTER']) && 1 == $this->mpdf->tableLevel) {
                ...
                if (isset($properties['OVERFLOW'])) {
                    ...
                    if (($this->mpdf->ColActive || $this->mpdf->tableLevel > 1) && 'visible' == $table['overflow']) {
                ...
                if (isset($attr['BORDER']) && '1' == $attr['BORDER']) {
                ...
                if ($w) {
                    ...
                    if (strpos($w, '%') && 1 == $this->mpdf->tableLevel && !$this->mpdf->ignore_table_percents) {
                ...
                if (isset($attr['AUTOSIZE']) && 1 == $this->mpdf->tableLevel) {
                    $this->mpdf->shrink_this_table_to_fit = $attr['AUTOSIZE'];
                    if ($this->mpdf->shrink_this_table_to_fit < 1) {
                        $this->mpdf->shrink_this_table_to_fit = 1;
                    }
                }
                if (isset($attr['ROTATE']) && 1 == $this->mpdf->tableLevel) {
                ...
                if (1 == $this->mpdf->tableLevel && $this->mpdf->useGraphs) {
            ...
            case 'THEAD':
                ...
                if (isset($properties['FONT-VARIANT'])) {
                    if ('SMALL-CAPS' == strtoupper($properties['FONT-VARIANT'])) {
            ...
            case 'TD':
                ...
                if ($this->mpdf->simpleTables && 0 == $this->mpdf->row && 0 == $this->mpdf->col) {
                ...
                if ($this->mpdf->table_border_attr_set) {
                    if ($table['border_details']) {
                        ...
                        } elseif ($this->mpdf->simpleTables && 0 == $this->mpdf->row && 0 == $this->mpdf->col) {
                ...
                if ($this->mpdf->tablethead) {
                    ...
                    if ('B' == $this->mpdf->thead_font_weight) {
                        $this->mpdf->SetStyle('B', true);
                    }
                    if ('I' == $this->mpdf->thead_font_style) {
                        $this->mpdf->SetStyle('I', true);
                    }
                    if ('S' == $this->mpdf->thead_font_smCaps) {
                ...
                if ($this->mpdf->tabletfoot) {
                    ...
                    if ('B' == $this->mpdf->tfoot_font_weight) {
                        $this->mpdf->SetStyle('B', true);
                    }
                    if ('I' == $this->mpdf->tfoot_font_style) {
                        $this->mpdf->SetStyle('I', true);
                    }
                    if ('S' == $this->mpdf->tfoot_font_style) {
                        $this->mpdf->textvar = ($this->mpdf->textvar | FC_SMALLCAPS);
                    } // mPDF 5.7.1
                }
                ...
                if (isset($properties['TEXT-ALIGN']) && $properties['TEXT-ALIGN']) {
                    if ('D' == substr($properties['TEXT-ALIGN'], 0, 1)) {
                ...
                if (!$c['a']) {
                    if (isset($c['direction']) && 'rtl' == $c['direction']) {
                        $c['a'] = 'R';
                    } else {
                        $c['a'] = 'L';
                    }
                ...
                if (isset($properties['TEXT-ROTATE']) && ($properties['TEXT-ROTATE'] || '0' === $properties['TEXT-ROTATE'])) {
                ...
                if ($this->mpdf->simpleTables && 0 == $this->mpdf->row && 0 == $this->mpdf->col && !$table['borders_separate'] && $table['simple']['border']) {
                ...
                if (isset($properties['WHITE-SPACE'])) {
                    if ('NOWRAP' == strtoupper($properties['WHITE-SPACE'])) {
                        $c['nowrap'] = 1;
                    }
                }
                $properties = [];
    ...
    public function CloseTag($tag, &$ahtml, &$ihtml): void
    { // mPDF 6
        //Closing tag
        if ('OPTION' == $tag) {
        ...
        if ('TTS' == $tag or 'TTA' == $tag or 'TTZ' == $tag) {
            if ($this->mpdf->InlineProperties[$tag]) {
                $this->mpdf->restoreInlineProperties($this->mpdf->InlineProperties[$tag]);
            }
            unset($this->mpdf->InlineProperties[$tag]);
        ...
        if ('FONT' == $tag || 'SPAN' == $tag || 'CODE' == $tag || 'KBD' == $tag || 'SAMP' == $tag || 'TT' == $tag || 'VAR' == $tag || 'INS' == $tag || 'STRONG' == $tag || 'CITE' == $tag || 'SUB' == $tag || 'SUP' == $tag || 'S' == $tag || 'STRIKE' == $tag || 'DEL' == $tag || 'Q' == $tag || 'EM' == $tag || 'B' == $tag || 'I' == $tag || 'U' == $tag | 'SMALL' == $tag || 'BIG' == $tag || 'ACRONYM' == $tag || 'MARK' == $tag || 'TIME' == $tag || 'PROGRESS' == $tag || 'METER' == $tag || 'BDO' == $tag || 'BDI' == $tag
        ) {
            $annot = false; // mPDF 6
            $bdf = false; // mPDF 6
            // mPDF 5.7.3 Inline tags
            if ('PROGRESS' == $tag || 'METER' == $tag) {
        ...
        if ('P' == $tag || 'DIV' == $tag || 'H1' == $tag || 'H2' == $tag || 'H3' == $tag || 'H4' == $tag || 'H5' == $tag || 'H6' == $tag || 'PRE' == $tag || 'FORM' == $tag || 'ADDRESS' == $tag || 'BLOCKQUOTE' == $tag || 'CENTER' == $tag || 'DT' == $tag || 'DD' == $tag || 'DL' == $tag || 'CAPTION' == $tag || 'FIELDSET' == $tag || 'UL' == $tag || 'OL' == $tag || 'LI' == $tag || 'ARTICLE' == $tag || 'ASIDE' == $tag || 'FIGURE' == $tag || 'FIGCAPTION' == $tag || 'FOOTER' == $tag || 'HEADER' == $tag || 'HGROUP' == $tag || 'MAIN' == $tag || 'NAV' == $tag || 'SECTION' == $tag || 'DETAILS' == $tag || 'SUMMARY' == $tag
            ...
            if (preg_match('/^H\d/', $tag) && !$this->mpdf->tableLevel && !$this->mpdf->writingToC) {
                if (isset($this->mpdf->h2toc[$tag]) || isset($this->mpdf->h2bookmarks[$tag])) {
                    $content = '';
                    if (1 == count($this->mpdf->textbuffer)) {
                        $content = $this->mpdf->textbuffer[0][0];
                    } else {
                        for ($i = 0; $i < count($this->mpdf->textbuffer); ++$i) {
                            if ("\xbb\xa4\xac" != substr($this->mpdf->textbuffer[$i][0], 0, 3)) { //inline object
            ...
            elseif (-1 == $this->mpdf->lastblocklevelchange) {
                $blockstate = 2;
            ...
            if (count($this->mpdf->textbuffer) && $this->mpdf->textbuffer[count($this->mpdf->textbuffer) - 1]) {
                if ("\xbb\xa4\xac" != substr($this->mpdf->textbuffer[count($this->mpdf->textbuffer) - 1][0], 0, 3)) { // not special content
            ...
            if (0 == count($this->mpdf->textbuffer) && 0 != $this->mpdf->lastblocklevelchange) {
                ...
                $this->mpdf->newFlowingBlock($this->mpdf->blk[$this->mpdf->blklvl]['width'], $this->mpdf->lineheight, '', false, $blockstate, true, ($this->mpdf->blk[$this->mpdf->blklvl]['direction'] ?? 'ltr'));
                $this->mpdf->finishFlowingBlock(true); // true = END of flowing block
            ...
            // -- CSS-FLOAT --
            if ('R' == $this->mpdf->blk[$this->mpdf->blklvl]['float']) {
            ...
            if ('L' == $this->mpdf->blk[$this->mpdf->blklvl]['float']) {
                // If width not set, here would need to adjust and output buffer
                $s = $this->mpdf->PrintPageBackgrounds();
                // Writes after the marker so not overwritten later by page background etc.
                $this->mpdf->pages[$this->mpdf->page] = preg_replace('/(___BACKGROUND___PATTERNS'.$this->mpdf->uniqstr.')/', '\\1'."\n".$s."\n", $this->mpdf->pages[$this->mpdf->page]);
            ...
            if (isset($this->mpdf->blk[$this->mpdf->blklvl]['visibility']) && 'visible' != $this->mpdf->blk[$this->mpdf->blklvl]['visibility']) {
        ...
        if (('TH' == $tag or 'TD' == $tag) && $this->mpdf->tableLevel) {
        ...
        if ('TR' == $tag && $this->mpdf->tableLevel) {
        ...
        if ('TABLE' == $tag) { // TABLE-END (
            ...
            for ($k = 0; $k < $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['nr']; ++$k) {
                for ($l = 0; $l < $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['nc']; ++$l) {
                    if (!isset($this->mpdf->cell[$k][$l])) {
                        for ($n = $l - 1; $n >= 0; --$n) {
                            if (isset($this->mpdf->cell[$k][$n]) && 0 != $this->mpdf->cell[$k][$n]) {
                                break;
                            }
                        }
                        $this->mpdf->cell[$k][$l] = [
            ...
            if (isset($this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['is_tfoot']) && count($this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['is_tfoot'])) {
                ...
                for ($k = 0; $k < $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['nr']; ++$k) {
                    if (!in_array($k, $tfrows)) {
                        $temptrbgi[] = ($this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['trbackground-images'][$k] ?? null);
                        $temptrbgg[] = ($this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['trgradients'][$k] ?? null);
                        $temptrbgc[] = ($this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['bgcolor'][$k] ?? null);
                    }
                }
                for ($k = 0; $k < $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['nr']; ++$k) {
                    if (in_array($k, $tfrows)) {
            ...
            if (isset($this->mpdf->table[1][1]['overflow']) && 'visible' == $this->mpdf->table[1][1]['overflow']) {
            ...
            if ('visible' == $this->mpdf->table[1][1]['overflow']) {
                ...
                } elseif ($this->mpdf->table_keep_together || (1 == $this->mpdf->table[1][1]['nr'] && !$this->mpdf->writingHTMLfooter)) {
